...
namespace AppodealAds.Unity.iOS
{
    ...
    public class AppodealAdsClient : IAppodealAdsClient
    {
        ...
        {
            Debug.Log("Not Supported by iOS SDK getBuildDate was called. Returning default value"); 
            return default;
        }
        ...
        public void validateAppStoreInAppPurchase(IAppStoreInAppPurchase purchase, IInAppPurchaseValidationListener listener)
        {
            ...
            AppodealObjCBridge.AppodealValidateInAppPurchase(purchase, inAppPurchaseValidationSucceeded, inAppPurchaseValidationFailed);
        }
